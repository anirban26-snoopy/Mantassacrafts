    ...
    <div className="mx-auto max-w-4xl px-5 py-14">
      ...
      <div className="font-bn prose prose-neutral mt-6 max-w-none text-ink-soft">
        <p>
          ...
          হিসেবে, যেখানে কাপড় ও মাটির জুমকা হাতে আঁকা হত, এবং তখন থেকেই এটি
          চালাচ্ছেন শ্রেষ্ঠা ঘোষ। প্রতিটি গয়না শুরু হয়েছিল লোকশিল্পের প্রতি
          ভালোবাসা আর নিজের মতো কিছু তৈরির ইচ্ছা থেকে।
        </p>
        <p>
          আমাদের সিগনেচার জুমকা আজও স্টুডিওর প্রাণ। প্রতিটি জোড়া হাতে আঁকা
          হয় ক্রেতার নাম দিয়ে, বাংলা বা ইংরেজি হরফে, সঙ্গে থাকে পম পম বর্ডার
          আর রুপালি রঙের জুমকা ঘণ্টা। গুগলে আমাদের রেটিং ৪.৮, ক্রেতারা
        ...
        <p>
          এখন আমরা স্টুডিওটিকে নতুন করে অনলাইনে নিয়ে আসছি, পুরনো জুমকার
